...
public class SistemGajiPNS {
	public static void main (String [] args ) {
		...
		int mkg, nip;
		double gapok = 0, tunjanganStatus = 0, gatot, jumlahAnak = 0, tunjanganBeras, jumlahJiwa = 0, tunjanganAnak = 0, temp  ;
		...
		System.out.print("Masukan Masa Kerja Golongan anda \t: ");
		mkg = keyboard.nextInt();
		System.out.print("Masukan NIP anda \t: ");
		nip = keyboard.nextInt();
		...
		if (status.equals ("sudah")) {
			...
			if (gol.equals ("IA")) {
			System.out.print("Gaji Pokok anda adalah Rp. " +golIA[mkg]+ "");
			gapok = golIA[mkg]; 
			}
		else if (gol.equals ("IB")) {
			System.out.print("Gaji Pokok anda adalah Rp. " +golIB[mkg]+ "");
			gapok = golIB[mkg];
			}
		else if (gol.equals ("IC")) {
			System.out.print("Gaji Pokok anda adalah Rp. " +golIC[mkg]+ "");
			gapok = golIC[mkg];
		}
		else if (gol.equals ("ID")) {
			System.out.print("Gaji Pokok anda adalah Rp. " +golID[mkg]+ "");
			gapok = golID[mkg];
		}
		else if (gol.equals ("IIA")) {
			System.out.print("Gaji Pokok anda adalah Rp. " +golIIA[mkg]+ "");
			gapok = golIIA[mkg];
		}
		else if (gol.equals ("IIB")) {
			System.out.print("Gaji Pokok anda adalah Rp. " +golIIB[mkg]+ "");
			gapok = golIIB[mkg];
		}
		else if (gol.equals ("IIC")) {
			System.out.print("Gaji Pokok anda adalah Rp. " +golIIC[mkg]+ "");
			gapok = golIIC[mkg];
		}
		else if (gol.equals ("IID")) {
			System.out.print("Gaji Pokok anda adalah Rp. " +golIID[mkg]+ "");
			gapok = golIID[mkg];
		}
		else if (gol.equals ("IIIA")) {
			System.out.print("Gaji Pokok anda adalah Rp. " +golIIIA[mkg]+ "");
			gapok = golIIIA[mkg];
		}
		else if (gol.equals ("IIIB")) {
			System.out.print("Gaji Pokok anda adalah Rp. " +golIIIB[mkg]+ "");
			gapok = golIIIB[mkg];
		}
		else if (gol.equals ("IIIC")) {
			System.out.print("Gaji Pokok anda adalah Rp. " +golIIIC[mkg]+ "");
			gapok = golIIIC[mkg];
		}
		else if (gol.equals ("IVA")) {
			System.out.print("Gaji Pokok anda adalah Rp. " +golIVA[mkg]+ "");
			gapok = golIVA[mkg];
		}
		else if (gol.equals ("IVB")) {
			System.out.print("Gaji Pokok anda adalah Rp. " +golIVB[mkg]+ "");
			gapok = golIVB[mkg];
		}
		else if (gol.equals ("IVC")) {
			System.out.print("Gaji Pokok anda adalah Rp. " +golIVC[mkg]+ "");
			gapok = golIVC[mkg];
		}
		else if (gol.equals ("IVD")) {
			System.out.print("Gaji Pokok anda adalah Rp. " +golIVD[mkg]+ "");
			gapok = golIVD[mkg];
		}
		else if (gol.equals ("IVE")) {
			System.out.print("Gaji Pokok anda adalah Rp. " +golIVE[mkg]+ "");
			gapok = golIVE[mkg];
		}


		tunjanganStatus = (gapok * 0.1) * jumlahJiwa;
		tunjanganAnak = (gapok * 0.02) * jumlahAnak;
		tunjanganBeras = 100000 * jumlahJiwa ;
		gatot = gapok + tunjanganAnak + tunjanganStatus + tunjanganBeras;
