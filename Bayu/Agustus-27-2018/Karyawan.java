...
public class Karyawan {
	...
	private double  lembur, gaji, umk, tunjTransport, tunjKeluarga, bpjsKes, bpjsKet, gajiTotal;
	int krwng = 3919291, bdg = 3091345, jkt = 3648035;
	
	public Karyawan(String nama, String level, String klg, String tempatKerja, String div, int nik) {
		super();
		this.nama = nama;
