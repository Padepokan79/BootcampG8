...
public class SistemGajiPNS1 {
	public static void main (String [] args ) {
		...
		int mkg;
		long nip;
		double gator, gajiNetto, gajiNettoTahun, iuranPensiun, biayaJabatan, tunjanganStruktural, tunjanganFungsional = 0, tunjanganEselon = 0, gapok = 0, tunjanganStatus = 0, gatot, jumlahAnak = 0, tunjanganBeras, jumlahJiwa = 1, tunjanganAnak = 0, temp, istriSuami = 0, tunjanganPulauTerpencil = 0, besarPangkat = 0, tunjanganPapua = 0  ;
		...
		if ( profesiJabatan.equals("dokter") || profesiJabatan.equals("guru") || profesiJabatan.equals("dosen")) {
		...
		gator = gapok + tunjanganAnak + tunjanganStatus + tunjanganBeras + tunjanganPapua + tunjanganPulauTerpencil + tunjanganFungsional + tunjanganStruktural;
		...
		System.out.println("Tunjangan Umum anda adalah Rp.  ");
		System.out.println("Tunjangan Tambahan Umum anda adalah Rp.  ");
		System.out.println("Tunjangan Pajak anda adalah Rp.  ");
		System.out.println("Tunjangan Bulat anda adalah Rp.  ");
		System.out.println("Tunjangan Lainnya anda adalah Rp.  ");
		System.out.println("Jumlah Gaji Kotor anda adalah Rp.  ");
		System.out.println("Potongan Taperum anda adalah Rp.  ");
		System.out.println("Potongan PPh anda adalah Rp.  ");
		System.out.println("Potongan sewa rumah anda adalah Rp.  ");
		System.out.println("Potongan Iuran Wajib Pegawai anda adalah Rp.  ");
		System.out.println("Potongan Tunggakan anda adalah Rp.  ");
		System.out.println("Potongan Utang anda adalah Rp.  ");
		System.out.println("Potongan Lain-lain anda adalah Rp.  ");
		System.out.println("Potongan Beras anda adalah Rp.  ");
		System.out.println("Jumlah Potongan anda adalah Rp.  ");
		System.out.println("Gaji total anda adalah Rp. " +gator+ " ");
