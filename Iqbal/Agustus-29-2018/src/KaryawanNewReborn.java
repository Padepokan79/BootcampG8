...
public class KaryawanNewReborn {
	...
	double getGapok() {
		return gapok(pekerjaan , penempatanKerja);
	}
	double getGator() {
	...
	void outPut() {	
		...
		System.out.println("Gaji Lembur		: "+gajiLembur(jamLembur));
		...
		System.out.println("Gaji Diterima	: "+(jumlahPenghasilanKu(gajiKotor(gapok(pekerjaan,penempatanKerja),tunjanganFamili(statusKeluarga), tunjanganEmployee(masaKerja) , tunjanganKhusus(penempatanKerja)) , gajiLembur(jamLembur)) - jumlahPotonganKu(pph(gapok(pekerjaan,penempatanKerja) , tunjanganFamili(statusKeluarga), gajiKotor(gapok(pekerjaan,penempatanKerja),tunjanganFamili(statusKeluarga), tunjanganEmployee(masaKerja) , tunjanganKhusus(penempatanKerja)) ,jumlahKeluarga) , bpjsKesehatan(gajiKotor(gapok(pekerjaan,penempatanKerja),tunjanganFamili(statusKeluarga), tunjanganEmployee(masaKerja) , tunjanganKhusus(penempatanKerja))) , bpjsKetenagaKerjaan(gajiKotor(gapok(pekerjaan,penempatanKerja),tunjanganFamili(statusKeluarga), tunjanganEmployee(masaKerja) , tunjanganKhusus(penempatanKerja))))) );
	} 
