...
public class TS extends Karyawan  implements UMK , TPegawai , TKeluarga , TTransport , BPJS , PPH , Lembur {
	//Variable
	double bonus;
	...
	public void setBonus(double test) {
		if(test > 2000) {
			bonus = 500000;
		}
		else
			bonus = ((int)test/100)*25000;
	}
	...
	public void setTunjanganPegawai() {
		tunjanganPegawai.put("junior" , (double) 120000);
		tunjanganPegawai.put("middle" , (double) 200000);
		tunjanganPegawai.put("senior" , (double) 325000);
